...
#   threshold. In existing deployments, the threshold should be set high (e.g. 5) and tightened
#   gradually in order to avoid large spikes in password resets and support requests.
# .. toggle_use_cases: open_edx
# .. toggle_creation_date: 2022-03-29
